...
- When opening a Pull Request, set: labels (component/type of change), assignees (the agent/developer who did the work),
  and the relevant GitHub Project (if the repository uses one), instead of leaving these fields empty.
